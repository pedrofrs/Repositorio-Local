...
HELLI_STATIC = pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoHelli.png"))
...
HELLI_MOVING = [
    ...
    pygame.image.load(os.path.join(IMG_DIR, "Dino/DinoHelli_copy.png")),
]
...
HELLI_ICON = pygame.image.load(os.path.join(IMG_DIR, 'Dino/DinoHelli_Icon.png'))
